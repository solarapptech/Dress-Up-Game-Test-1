...
this.tween5.play();
    ...
    // Shirt 
    let shirt = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.42,"shirt_1")
    shirt.setVisible(false);
    shirt.setDepth(9);

    // Skirt 
    let skirt = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.42,"skirt_1")
    skirt.setVisible(false);
    skirt.setDepth(6);

    // Pants
    let pants = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.42,"pants_1")
    ...
    // ACC 2
    let acc2 = this.add.image(this.game.renderer.width / 2, this.game.renderer.height * 0.42,"acc2_1")
    ...
    shirt.setTexture("shirt_" + localStorage.getItem('shirt_id' + this.cur_slot));
    ...
    skirt.setTexture("skirt_" + localStorage.getItem('skirt_id' + this.cur_slot));
    ...
    pants.setTexture("pants_" + localStorage.getItem('pants_id' + this.cur_slot));
    ...
    acc2.setTexture("acc2_" + localStorage.getItem('acc2_id' + this.cur_slot));
...
if(this.slotnum > 0){
    ...
    let shirt_gph = this.add.image((this.game.renderer.width) + (localStorage.getItem('shirtxmanh' + number) * 0.3), (this.game.renderer.height * 0.70) + (localStorage.getItem('shirtymanh' + number) * 0.3),'shirt_1');
    ...
    let skirt_gph = this.add.image((this.game.renderer.width) + (localStorage.getItem('skirtxmanh' + number) * 0.3), (this.game.renderer.height * 0.70) + (localStorage.getItem('skirtymanh' + number) * 0.3),'skirt_1');
    ...
    let pants_gph = this.add.image((this.game.renderer.width) + (localStorage.getItem('pantsxmanh' + number) * 0.3), (this.game.renderer.height * 0.70) + (localStorage.getItem('pantsymanh' + number) * 0.3),'pants_1');
    ...
    let acc2_gph = this.add.image(this.game.renderer.width, this.game.renderer.height * 0.70,'acc2_1');
