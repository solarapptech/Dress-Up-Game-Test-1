...
this.input.on('dragend', ()=>{
    ...
    // Shirts
    let shirt1 = this.add.image(-400, -400, "shirt_1");
    let shirt2 = this.add.image(-400, -400, "shirt_2");
    let shirt3 = this.add.image(-400, -400, "shirt_3");
    let shirt4 = this.add.image(-400, -400, "shirt_4");
    ...
    // Skirt
    let skirt1 = this.add.image(-400, -400, "skirt_1");
    let skirt2 = this.add.image(-400, -400, "skirt_2");
    let skirt3 = this.add.image(-400, -400, "skirt_3");
    let skirt4 = this.add.image(-400, -400, "skirt_4");

    // Pants
    let pants1 = this.add.image(-400, -400, "pants_1");
    let pants2 = this.add.image(-400, -400, "pants_2");
    let pants3 = this.add.image(-400, -400, "pants_3");
    let pants4 = this.add.image(-400, -400, "pants_4");

    // STRAINS (ACC1)
    let acc1_1 = this.add.image(-400, -400, "strains_1");

    // Accessories 2
    let acc2_1 = this.add.image(-400, -400, "acc2_1");
    let acc2_2 = this.add.image(-400, -400, "acc2_2");
    let acc2_3 = this.add.image(-400, -400, "acc2_3");
    let acc2_4 = this.add.image(-400, -400, "acc2_4");
    let acc2_5 = this.add.image(-400, -400, "acc2_5");
    let acc2_6 = this.add.image(-400, -400, "acc2_6");
    ...
    hairs.createMultiple({ key: 'hairs', frame: [ 0,1,2,3,4 ], repeat: -1 });
    this.hairs = hairs;
    hairs.setDepth(11);
    
    let hairs_qty = 0;
    let hairs_pick = [hair1, hair2, hair3, hair4, hair5,];
    ...
    backhairs.createMultiple({ key: 'backhairs', frame: [ 0,1,2,3,4,5 ], repeat: -1 });
    this.backhairs = backhairs;
    backhairs.setDepth(11);

    
    let backhairs_qty = 0;
    let backhairs_pick = [backhair1, backhair2, backhair3, backhair4, backhair5, backhair6];
    ...
    backhair5.setPosition(-800,-400), backhair6.setPosition(-800,-400), 
    ])
    ...
    skirts.createMultiple({ key: 'skirts', frame: [ 0,1,2,3 ], repeat: -1 });
    this.skirts = skirts;
    skirts.setDepth(11);

    let skirts_qty = 0;
    let skirts_pick = [skirt1, skirt2, skirt3, skirt4];
    ...
    this.data.set('val6',0);
    layer5.remove([
    skirt1.setPosition(-800,-400),skirt2.setPosition(-800,-400), skirt3.setPosition(-800,-400), skirt4.setPosition(-800,-400),
    ])
    ...
    acc2.createMultiple({ key: 'acc2', frame: [ 0,1,2,3,4,5 ], repeat: -1 });
    this.acc2 = acc2;
    acc2.setDepth(11);

    let acc2_qty = 0;
    let acc2_pick = [acc2_1, acc2_2, acc2_3, acc2_4, acc2_5, acc2_6];
    ...
    layer12.remove([
    acc2_1.setPosition(-800,-400), acc2_2.setPosition(-800,-400), acc2_3.setPosition(-800,-400), acc2_4.setPosition(-800,-400),
    acc2_5.setPosition(-800,-400), acc2_6.setPosition(-800,-400),
    ])
...
if(this.load_true === 1){
    ...
    let hair_no = [hair1,hair2,hair3,hair4,hair5];
    ...
    let backhairid_no = [backhair1,backhair2,backhair3,backhair4,backhair5,backhair6];
    ...
    let skirtid_no = [skirt1,skirt2,skirt3,skirt4];
    ...
    let acc2id_no = [acc2_1,acc2_2,acc2_3,acc2_4,acc2_5,acc2_6];
