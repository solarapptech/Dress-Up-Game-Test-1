...
var load_scene = exports.load_scene = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  return _createClass(load_scene, [{
    ...
    value: function preload() {
      ...
      this.load.image("main_doll", "./assets/doll/main_doll.png");
      ...
      // Shirt Graphics
      this.load.image("shirt_1", "./assets/shirt/shirt_gph1.png");
      this.load.image("shirt_2", "./assets/shirt/shirt_gph2.png");
      this.load.image("shirt_3", "./assets/shirt/shirt_gph3.png");
      this.load.image("shirt_4", "./assets/shirt/shirt_gph4.png");

      // Skirt Graphics
      this.load.image("skirt_1", "./assets/skirt/skirt_gph1.png");
      this.load.image("skirt_2", "./assets/skirt/skirt_gph2.png");
      this.load.image("skirt_3", "./assets/skirt/skirt_gph3.png");
      this.load.image("skirt_4", "./assets/skirt/skirt_gph4.png");

      // Pants Graphics
      this.load.image("pants_1", "./assets/pants/pants_gph1.png");
      this.load.image("pants_2", "./assets/pants/pants_gph2.png");
      this.load.image("pants_3", "./assets/pants/pants_gph3.png");
      this.load.image("pants_4", "./assets/pants/pants_gph4.png");

      // STRAINS (Acc1) Graphics
      this.load.image("strains_1", "./assets/strains/strains_1.png");

      // Acc2 Graphics
      this.load.image("acc2_1", "./assets/acc2/acc2_gph1.png");
      this.load.image("acc2_2", "./assets/acc2/acc2_gph2.png");
      this.load.image("acc2_3", "./assets/acc2/acc2_gph3.png");
      this.load.image("acc2_4", "./assets/acc2/acc2_gph4.png");
      this.load.image("acc2_5", "./assets/acc2/acc2_gph5.png");
      this.load.image("acc2_6", "./assets/acc2/acc2_gph6.png");
        ...
        if (this.flag_load === 0) {
          ...
          this.tween7 = this.tweens.add({
            ...
            onComplete: function onComplete(pointer) {
              ...
              // Shirt 
              var shirt = _this2.add.image(_this2.game.renderer.width / 2, _this2.game.renderer.height * 0.42, "shirt_1");
              shirt.setVisible(false);
              shirt.setDepth(9);

              // Skirt 
              var skirt = _this2.add.image(_this2.game.renderer.width / 2, _this2.game.renderer.height * 0.42, "skirt_1");
              skirt.setVisible(false);
              skirt.setDepth(6);

              // Pants
              var pants = _this2.add.image(_this2.game.renderer.width / 2, _this2.game.renderer.height * 0.42, "pants_1");
              ...
              // ACC 2
              var acc2 = _this2.add.image(_this2.game.renderer.width / 2, _this2.game.renderer.height * 0.42, "acc2_1");
                  ...
                  loadslot.on('pointerdown', function () {
                    if (_this2.flag_lore === 0) {
                      ...
                      if (localStorage.getItem('shirt_id' + _this2.cur_slot) > 0) {
                        shirt.setTexture("shirt_" + localStorage.getItem('shirt_id' + _this2.cur_slot));
                      ...
                      if (localStorage.getItem('skirt_id' + _this2.cur_slot) > 0) {
                        skirt.setTexture("skirt_" + localStorage.getItem('skirt_id' + _this2.cur_slot));
                      ...
                      if (localStorage.getItem('pants_id' + _this2.cur_slot) > 0) {
                        pants.setTexture("pants_" + localStorage.getItem('pants_id' + _this2.cur_slot));
                      ...
                      if (localStorage.getItem('acc2_id' + _this2.cur_slot) > 0) {
                        acc2.setTexture("acc2_" + localStorage.getItem('acc2_id' + _this2.cur_slot));
              ...
              if (_this2.slotnum > 0) {
                for (var _i5 = 0; _i5 < _this2.slotnum; _i5++) {
                  ...
                  var shirt_gph = _this2.add.image(_this2.game.renderer.width + localStorage.getItem('shirtxmanh' + number) * 0.3, _this2.game.renderer.height * 0.70 + localStorage.getItem('shirtymanh' + number) * 0.3, 'shirt_1');
                  ...
                  var skirt_gph = _this2.add.image(_this2.game.renderer.width + localStorage.getItem('skirtxmanh' + number) * 0.3, _this2.game.renderer.height * 0.70 + localStorage.getItem('skirtymanh' + number) * 0.3, 'skirt_1');
                  ...
                  var pants_gph = _this2.add.image(_this2.game.renderer.width + localStorage.getItem('pantsxmanh' + number) * 0.3, _this2.game.renderer.height * 0.70 + localStorage.getItem('pantsymanh' + number) * 0.3, 'pants_1');
                  ...
                  var acc2_gph = _this2.add.image(_this2.game.renderer.width, _this2.game.renderer.height * 0.70, 'acc2_1');
                  ...
                  if (localStorage.getItem('skirt_id' + num) > 0) {
                    skirt_gph.setTexture("skirt_" + localStorage.getItem('skirt_id' + num));
                  ...
                  if (localStorage.getItem('pants_id' + num) > 0) {
                    pants_gph.setTexture("pants_" + localStorage.getItem('pants_id' + num));
                  ...
                  if (localStorage.getItem('acc2_id' + num) > 0) {
                    acc2_gph.setTexture("acc2_" + localStorage.getItem('acc2_id' + num));
                    acc2_gph.setVisible(true);
                    acc2_gph.setDepth(20);
                    acc2_gph.setScale(0.33);
                    _this2.layer12.add(acc2_gph);
                  }
...
var game_scene = exports.game_scene = /*#__PURE__*/function (_Phaser$Scene) {
  ...
  return _createClass(game_scene, [{
    ...
    value: function preload() {
      ...
      this.data.set('acc2_4', 0);
      this.data.set('acc2_5', 0);
      this.data.set('acc2_6', 0);
    ...
    value: function create(data) {
          ...
          _this2.time.delayedCall(600, function () {
            _this2.input.on('pointerdown', function () {
              if (this.flag3 === 1) {
                ...
                this.flag3 = 0;
                // Return Shirt Flag to Default Position
      ...
      // Shirts
      var shirt1 = this.add.image(-400, -400, "shirt_1");
      var shirt2 = this.add.image(-400, -400, "shirt_2");
      var shirt3 = this.add.image(-400, -400, "shirt_3");
      var shirt4 = this.add.image(-400, -400, "shirt_4");
      ...
      // Skirt
      var skirt1 = this.add.image(-400, -400, "skirt_1");
      var skirt2 = this.add.image(-400, -400, "skirt_2");
      var skirt3 = this.add.image(-400, -400, "skirt_3");
      var skirt4 = this.add.image(-400, -400, "skirt_4");

      // Pants
      var pants1 = this.add.image(-400, -400, "pants_1");
      var pants2 = this.add.image(-400, -400, "pants_2");
      var pants3 = this.add.image(-400, -400, "pants_3");
      var pants4 = this.add.image(-400, -400, "pants_4");

      // STRAINS (ACC1)
      var acc1_1 = this.add.image(-400, -400, "strains_1");

      // Accessories 2
      var acc2_1 = this.add.image(-400, -400, "acc2_1");
      var acc2_2 = this.add.image(-400, -400, "acc2_2");
      var acc2_3 = this.add.image(-400, -400, "acc2_3");
      var acc2_4 = this.add.image(-400, -400, "acc2_4");
      var acc2_5 = this.add.image(-400, -400, "acc2_5");
      var acc2_6 = this.add.image(-400, -400, "acc2_6");
      ...
      layer10.add([hair1.setPosition(0, 0)]);
      ...
      dress_slot.on('pointerdown', function () {
        _this.dress.destroy(true);
        _this.tops.destroy(true);
        _this.hairs.destroy(true);
        _this.backhairs.destroy(true);
        _this.shirts.destroy(true);
        _this.skirts.destroy(true);
        _this.pants.destroy(true);
        _this.acc1.destroy(true);
        _this.acc2.destroy(true);
        _this.acc3.destroy(true);
        _this.eyes.destroy(true);
        _this.eyebrows.destroy(true);
        _this.noses.destroy(true);
        _this.mouths.destroy(true);
        _this.ears.destroy(true);
        _this.color_eyes.destroy(true);
        _this.backgrounds.destroy(true);
      ...
      hair_slot.on('pointerdown', function () {
        ...
        hairs.setDepth(11);
        var hairs_qty = 0;
        var hairs_pick = [hair1, hair2, hair3, hair4, hair5];
        layer16_qty = hairs_pick.length;
        layer16_y_cap = Number(Math.floor(hairs_pick.length / 5));
        layer16.setVisible(true);
        layer16.y = 0;
        tap4.play();
        ...
        hairs.getChildren().forEach(function (child) {
          ...
          child.on('pointerdown', function () {
            ...
            layer10.remove([hair1.setPosition(-800, -400), hair2.setPosition(-800, -400), hair3.setPosition(-800, -400), hair4.setPosition(-800, -400), hair5.setPosition(-800, -400)]);
            ...
            if (_this.data.get('hair' + child.id) === 0) {
              ...
              var child_id = Number(child.id - 1);
              layer10.setPosition(layerxpos, layerypos);
              layer10.add([hairs_pick[child_id].setPosition(0, 0)]);
      ...
      backhair_slot.on('pointerdown', function () {
        ...
        var backhairs_qty = 0;
        var backhairs_pick = [backhair1, backhair2, backhair3, backhair4, backhair5, backhair6];
        layer16_qty = backhairs_pick.length;
        layer16_y_cap = Number(Math.floor(backhairs_pick.length / 5));
        layer16.setVisible(true);
        layer16.y = 0;
        tap4.play();
        ...
        backhairs.getChildren().forEach(function (child) {
          ...
          child.on('pointerdown', function () {
            ...
            layer3.remove([backhair1.setPosition(-800, -400), backhair2.setPosition(-800, -400), backhair3.setPosition(-800, -400), backhair4.setPosition(-800, -400), backhair5.setPosition(-800, -400), backhair6.setPosition(-800, -400)]);
      ...
      skirt_slot.on('pointerdown', function () {
        ...
        // if(this.data.get('val6') != 0){
        // layer6.setInteractive();
        // this.input.setDraggable(layer6);
        // }else if(this.data.get('val6') === 0){
        // layer6.removeInteractive();
        // }
        ...
        skirts.setDepth(11);
        var skirts_qty = 0;
        var skirts_pick = [skirt1, skirt2, skirt3, skirt4];
        ...
        skirts.getChildren().forEach(function (child) {
          ...
          child.on('pointerdown', function () {
            ...
            // Remove all Images
            _this.data.set('val6', 0);
            layer5.remove([skirt1.setPosition(-800, -400), skirt2.setPosition(-800, -400), skirt3.setPosition(-800, -400), skirt4.setPosition(-800, -400)]);
      ...
      acc2_slot.on('pointerdown', function () {
        ...
        acc2.setDepth(11);
        var acc2_qty = 0;
        var acc2_pick = [acc2_1, acc2_2, acc2_3, acc2_4, acc2_5, acc2_6];
        ...
        acc2.getChildren().forEach(function (child) {
          ...
          child.on('pointerdown', function () {
            ...
            layer12.remove([acc2_1.setPosition(-800, -400), acc2_2.setPosition(-800, -400), acc2_3.setPosition(-800, -400), acc2_4.setPosition(-800, -400), acc2_5.setPosition(-800, -400), acc2_6.setPosition(-800, -400)]);
            ...
            if (_this.data.get('acc2_' + child.id) === 0) {
              ...
              layer12.add([acc2_pick[child_id].setPosition(0, 0)]);
      ...
      if (this.load_true === 1) {
        ...
        var hair_no = [hair1, hair2, hair3, hair4, hair5];
        var hair_length = hair_no.length;
        for (var _i12 = 0; _i12 < hair_length; _i12++) {
          var _id2 = _i12 + 1;
          if (hairid === _id2) {
            layer10.remove([hair1.setPosition(-800, -400)]);
            this.data.set('hair' + _id2, 1);
            this.data.set('val3', _id2);
            layer10.add([hair_no[_i12].setPosition(0, 0)]);
          }
        }

        // Load BackHair
        var backhairid = parseInt(localStorage.getItem('backhair_id' + this.slot_cur));
        var backhairid_no = [backhair1, backhair2, backhair3, backhair4, backhair5, backhair6];
        ...
        var skirtid_no = [skirt1, skirt2, skirt3, skirt4];
        ...
        var acc2id_no = [acc2_1, acc2_2, acc2_3, acc2_4, acc2_5, acc2_6];
        ...
        for (var _i18 = 0; _i18 < acc2id_length; _i18++) {
          ...
          if (acc2id === _id8) {
            ...
            layer12.add([acc2id_no[_i18].setPosition(0, 0)]);
          }
        }
